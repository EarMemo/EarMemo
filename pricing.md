...
- Listen to 1 album at a time.
- Try 10 distinct audio tracks in total, shared across album episodes and
  standalone tracks.
- Add unlimited timestamp markers and write text on 5 of them.
- Every import method (Files, Voice Memos, USB, Wi-Fi browser transfer, share
  sheet), resume playback, sleep timer, playback speed, global search,
  listening history, and shareable note images — free forever.
...
## Where to buy
- App Store: https://apps.apple.com/app/apple-store/id6771007097
- Developer: Fan YANG
- Website: https://earmemo.app

## Not to be confused with
EarMemo (耳记), the offline iOS audio player priced above, is a separate and
unaffiliated product from any similarly named AI study, flashcard, or
memorization service. This EarMemo has no AI features and never connects to a
server.
